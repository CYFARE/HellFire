...
<h2 align="center">
  ...
  <img src="https://img.shields.io/badge/-149.0a1-61DAFB?style=for-the-badge" alt="Version: 149.0a1">
</h2>
...
Note: Windows builds failing consistently. Microsoft Windows has been the single most bugged and worst system for developers and its users. Due to consistent issues exclusive to Windows, Microsoft Windows is removed from support completely, with immediate effect.
...
|------------------------|--------------------------------------------------------|--------------------------------------------------------|
| HellFire (GNU/Linux)   | `-O3` Optimized, Hardened Security, Sandbox Enabled, NVIDIA VA-API patch | AVX2 + SSE4.2 + Full LTO + PGO |

> For custom builds like 'hardened', 'Insecure' or mixed flag builds, please contact via: security@cyfare.net

For more details, explore the Mozconfig:

- [Linux64 Mozconfigs](https://github.com/CYFARE/HellFire/tree/main/MozConfigs/Linux64)

## Install & Update HellFire

Stay updated with the latest versions and installer on the [Releases](https://github.com/CYFARE/HellFire/releases/) page.

For GNU/Linux, install a <a href='https://github.com/CYFARE/HellFire/releases/'><img src="https://img.shields.io/badge/-FLATPAK-61DAFB?style=for-the-badge"></a> from releases page or follow the below process:
...
To update HellFire on GNU/Linux, follow the same steps and the installer script will update the browser without affecting any bookmarks, extensions or settings :)

## Building HellFire

Download the HellFire mozconfig from [HellFire MozConfigs](https://github.com/CYFARE/HellFire/tree/main/MozConfigs). Ensure you copy the desired mozconfig to `mozilla-unified` and rename it to `mozconfig` before running `./mach build`.

To build your own version, follow the [Firefox Build Guide](https://firefox-source-docs.mozilla.org/setup/). 
## Support
